...
//n is pushed into an array, and then subsets of set of first n-1 integers are found, this gives all subsets of set of first n-1 positive integers that also include n.
//n is popped from the array, and then subsets of set of first n-1 integers are found again, this gives all subsets of set of first n-1 positive integers not including n.
...
int subsets(int n) {
    ...
    if(n==0) {
        //process subset
        printf("[ ");
        for(int i = 0; i <= P->fill; i++) { printf("%.2f ", *(P->array + i)-1); }
        printf("]\n");
        return 0;
    } else {
        //core algorithm
...
int subsets1(DynamicArray* A, int n) {
    ...
    if(n==0) {
        //process subset
        printf("[ ");
        for(int i = 0; i <= P->fill; i++) { printf("%.2f ", *(A->array + (int)*(P->array + i) - 1)); }
        printf("]\n");
        return 0;
    } else {
        //core algorithm
